...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-xl border bg-[#eaeae5] p-1 text-muted-foreground',
      className
    )}
    {...props}
  />
